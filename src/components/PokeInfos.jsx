...
function PokeInfos(props) {
  ...
  return selectedPokemon !== null ? (
    <>
      ...
      <Card
        text="white"
        className={(props.loadingInfos ? "d-none" : "") + " px-4 py-3 rounded-4 shadow-lg"}
      ...
      >
        ...
        <Card.Body className="d-flex justify-content-between px-0">
          ...
          <div
            className="infos-right d-flex flex-column align-items-center"
            style={parseInt(selectedPokemon.id) === 133 ? { width: "70%" } : { width: "60%" }}
          >
            <fieldset>
              <legend className="d-flex align-items-center gap-2 mb-3">
                <MdCatchingPokemon />
                Evolution{selectedPokemon.apiPreEvolution !== "none" && selectedPokemon.apiEvolutions.length !== 0 ? "s" : ""} :
              </legend>
                    ...
                    <Fragment key={selectedPokemon.name}>
                      <div className="d-flex flex-column align-items-center gap-2">
                        ...
                        <figure className="text-center mt-2">
                          ...
                          <img
                            src={originalPokemons[selectedPokemon.apiPreEvolution.pokedexIdd - 1].sprite}
                            alt={originalPokemons[selectedPokemon.apiPreEvolution.pokedexIdd - 1].name}
                          />
                        </figure>
                      </div>
                    </Fragment>
                    ...
                    <div className="d-flex flex-column align-items-center gap-2" key={selectedPokemon.name + " " + selectedPokemon.id}>
                      ...
                      <div
                        className={
                          ...
                          (selectedPokemon.apiEvolutions.length > 2 ? " flex-wrap justify-content-around" : " flex-column")
                        }
                      >
